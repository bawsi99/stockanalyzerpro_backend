...
"""
    ...
    def _create_overlays(self, data: pd.DataFrame, indicators: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Define safe default quality thresholds for advanced patterns (central config removed)
            DEFAULT_PATTERN_MIN_QUALITY = {
                "head_and_shoulders": 50.0,
                "cup_and_handle": 50.0,
                "triple_patterns": 50.0,
                "wedge_patterns": 50.0,
                "channel_patterns": 50.0,
            }
            try:
                ...
                # Cup and Handle detection disabled by request
                ch_patterns = []
                print("🔍 DEBUG: Cup and Handle patterns detection disabled")
                ...
                for pattern in wedge_patterns:
                    try:
                        # Use configurable quality threshold
                        quality_score = pattern.get('quality_score', 0)
                        min_quality = DEFAULT_PATTERN_MIN_QUALITY.get("wedge_patterns", 0.0)
                        if quality_score < min_quality:
                            continue
                ...
                for pattern in channel_patterns:
                    try:
                        # Use configurable quality threshold
                        quality_score = pattern.get('quality_score', 0)
                        min_quality = DEFAULT_PATTERN_MIN_QUALITY.get("channel_patterns", 0.0)
                        if quality_score < min_quality:
                            continue
