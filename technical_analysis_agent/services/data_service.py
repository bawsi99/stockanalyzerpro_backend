...
# Local imports
from zerodha.ws_client import zerodha_ws_client, candle_aggregator
...
def tick_forward_hook(token, tick):
    ...
    from zerodha.ws_client import publish_callback, system_ready, MAIN_EVENT_LOOP
...
async def initialize_websocket_service():
    ...
    from zerodha.ws_client import set_publish_callback, set_main_event_loop
