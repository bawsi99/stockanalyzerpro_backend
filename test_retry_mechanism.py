#!/usr/bin/env python3
"""
Test script for the retry mechanism in the Gemini client.
This script simulates different types of errors to verify the retry behavior.
"""

import asyncio
import time
from gemini.error_utils import RetryMechanism, RetryConfig, GoogleAPIErrorHandler
