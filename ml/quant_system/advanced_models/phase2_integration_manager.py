...
from .neural_architecture_search import NeuralArchitectureSearch, NASConfig, create_nas_engine
from .meta_learning_framework import MetaLearningFramework, MetaLearningConfig, create_meta_learning_framework
from .advanced_training_strategies import AdvancedTrainer, AdvancedTrainingConfig, create_advanced_trainer
from .temporal_fusion_transformer import TemporalFusionTransformer, TFTConfig, TFTTrainer, create_tft_model, create_tft_trainer
...
class Phase2IntegrationManager:
    ...
    def discover_optimal_architectures(self, train_data: torch.Tensor, train_targets: torch.Tensor,
        ...
        for i, arch_result in enumerate(best_architectures):
            ...
            from .neural_architecture_search import DynamicNeuralNetwork
