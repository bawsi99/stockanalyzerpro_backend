...
from .pattern_ml import PatternMLEngine
from .raw_data_ml import RawDataMLEngine
from .hybrid_ml import HybridMLEngine
...
class UnifiedMLManager:
    ...
    def __init__(self, config: UnifiedMLConfig = None):
        ...
        self.pattern_engine = PatternMLEngine()
        self.raw_data_engine = RawDataMLEngine()
        self.hybrid_engine = HybridMLEngine()
        # self.traditional_engine = traditional_ml_engine  # REMOVED
        self.feature_engine = AdvancedFeatureEngineer()
